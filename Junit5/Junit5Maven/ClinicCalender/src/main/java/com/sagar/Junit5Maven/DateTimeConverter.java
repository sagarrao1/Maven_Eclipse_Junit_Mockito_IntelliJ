...
public class DateTimeConverter {
	...
	public static LocalDateTime convertToDateFromString(String dateTimeString, LocalDate today ) {
		...
		try {
			...
			throw new RuntimeException("Unable to create date time from: [" + dateTimeString.toUpperCase()
