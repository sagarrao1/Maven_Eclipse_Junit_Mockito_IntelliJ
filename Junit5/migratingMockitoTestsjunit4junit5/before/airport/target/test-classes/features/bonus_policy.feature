Feature: Bonus Policy
  ...
  Scenario Outline: Passenger bonus policy
    ...
    Examples:
      ...
      | flights_information.csv     | flights_information2.csv | flights_information3.csv | 123-45-6789                 | John Smith             | US          | 420                      |
      | flights_information.csv     | flights_information2.csv | flights_information3.csv | 900-45-6789                 | Jane Underwood         | GB          | 420                      |
      | flights_information.csv     | flights_information2.csv | flights_information3.csv | 123-45-6790                 | James Perkins          | US          | 630                      |
      | flights_information.csv     | flights_information2.csv | flights_information3.csv | 900-45-6790                 | Mary Calderon          | GB          | 630                      |
